...
STAT[LOCO,GEST]         = ini_read_real(etapa,"LOCO,gest",30);
STAT[LOCO,CRIAS]        = ini_read_real(etapa,"LOCO,crias",3);
...
STAT[JERGUILLA,CRIAS]   = ini_read_real(etapa,"JERGUILLA,crias",3);
